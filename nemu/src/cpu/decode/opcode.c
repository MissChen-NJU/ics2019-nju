...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, not_rm_b, __ref_neg_rm_b, mul_rm2a_b, imul_rm2a_b, div_rm2a_b, idiv_rm2a_b};

/* 0xf7 */
instr_func group_3_v_entry[8] =
    {test_i2rm_v, inv, not_rm_v, __ref_neg_rm_v, mul_rm2a_v, imul_rm2a_v, div_rm2a_b, idiv_rm2a_v};
