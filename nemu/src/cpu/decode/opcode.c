...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, adc_i2rm_b, __ref_sbb_i2rm_b, and_i2rm_b, sub_i2rm_b, __ref_xor_i2rm_b, cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, or_i2rm_v, adc_i2rm_v, __ref_sbb_i2rm_v, and_i2rm_v, sub_i2rm_v, __ref_xor_i2rm_v, cmp_i2rm_v};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, adc_i2rm_bv, __ref_sbb_i2rm_bv, and_i2rm_bv, sub_i2rm_bv, __ref_xor_i2rm_bv, cmp_i2rm_bv};
